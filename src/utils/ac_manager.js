...
const WalletShellApi = require('./ac_api');
const uiupdater = require('./acui_updater');
...
var WalletShellManager = function () {
 ...
 //   this.daemonPort = nodeAddress[1] || null;
    ...
    this.servicePort = '';
    this.serviceTimeout = '';
    this.serviceArgsDefault = ['--rpc-password', ''];
    this.walletConfigDefault = { 'rpc-password': '' };
...
//A new child process is started in instances like opening a wallet
